...
while True:
    ...
    temOitoCaracteres = len(senha) >= 8
    temNumero = bool(re.search(r'\d', senha)) # Verifica se há pelo menos um dígito na senha

    # --- Avaliação da Senha ---
    if temOitoCaracteres and temNumero:
        print("\n--- Senha FORTE! ---")
